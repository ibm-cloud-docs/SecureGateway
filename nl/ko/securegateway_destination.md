...
특정 규칙이 애플리케이션과 연관될 수도 있습니다.  연관된 규칙을 작성하는 방법에 대한 자세한 정보는 [앱에 대한 iptable 규칙을 작성하는 방법](/docs/services/SecureGateway/iptables.html)을 참조하십시오.
